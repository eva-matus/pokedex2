$(document).ready(function(){
          ...
          .then(function(response){ 
              ...
              response.results.forEach(function(info) {
                  ...
                  <div class="card-body">
                      ...
                      <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal_${info.name}">¡Quiero saber más de este pokémon!</button>
                  </div>
                  </div>`

                  let details = `<p> ${info.name} </p>`
                  
                  let button = `<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal_${info.name}">¡Quiero saber más de este pokémon!</button>`
  ...
  function getDetails(url_pokemon){
      ...
      .then(function(response){
             console.log(response)
              pokemon = response
              modal = `<div container class="modal fade" id="modal_${response.name}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#submodal__${response.name}" data-bs-dismiss="modal">
  ...
  function readAbility(arr){
      let text = ""
      arr.forEach(function(info){
          text = text + " " + "<li>"+(info.ability.name) + "<button type='button' class='btn btn-outline-info' data-bs-toggle='modal' data-bs-target='#abilitymodal__${response.name}' data-bs-dismiss='modal'> Ver otros pokemon con la misma habilidad </button></li>" 
      })
      return text
  }
